...
func TestImports(t *testing.T) {
	...
	aBar := "git.sr.ht/~sircmpwn/gqlgen/codegen/templates/testdata/a/bar"
	bBar := "git.sr.ht/~sircmpwn/gqlgen/codegen/templates/testdata/b/bar"
	mismatch := "git.sr.ht/~sircmpwn/gqlgen/codegen/templates/testdata/pkg_mismatch"
	...
	t.Run("lookup by type", func(t *testing.T) {
		...
		pkg := types.NewPackage("git.sr.ht/~sircmpwn/gqlgen/codegen/templates/testdata/b/bar", "bar")
	...
	t.Run("string printing for import block", func(t *testing.T) {
		...
		require.Equal(
			t,
			`"git.sr.ht/~sircmpwn/gqlgen/codegen/templates/testdata/a/bar"
bar1 "git.sr.ht/~sircmpwn/gqlgen/codegen/templates/testdata/b/bar"
turtles "git.sr.ht/~sircmpwn/gqlgen/codegen/templates/testdata/pkg_mismatch"`,
			a.String(),
		)
	})
	...
	t.Run("aliased imports will not collide", func(t *testing.T) {
		...
		require.Equal(t, `abar "git.sr.ht/~sircmpwn/gqlgen/codegen/templates/testdata/a/bar"
bbar "git.sr.ht/~sircmpwn/gqlgen/codegen/templates/testdata/b/bar"`, a.String())
	})
