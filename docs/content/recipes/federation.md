...
server in gqlgen. You can find the finished result in the [examples directory](https://git.sr.ht/~sircmpwn/gqlgen/tree/master/example/federation).
...
```bash
go run git.sr.ht/~sircmpwn/gqlgen
```
