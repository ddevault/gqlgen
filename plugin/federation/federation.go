	...
	builtins := config.TypeMap{
		"_Service": {
			Model: config.StringList{
				"git.sr.ht/~sircmpwn/gqlgen/plugin/federation/fedruntime.Service",
			},
		},
		"_Entity": {
			Model: config.StringList{
				"git.sr.ht/~sircmpwn/gqlgen/plugin/federation/fedruntime.Entity",
			},
		},
		"Entity": {
			Model: config.StringList{
		...
		"_Any": {
			Model: config.StringList{"git.sr.ht/~sircmpwn/gqlgen/graphql.Map"},
		},
	}
