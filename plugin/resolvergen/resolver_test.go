...
func TestLayoutSingleFile(t *testing.T) {
	...
	assertNoErrors(t, "git.sr.ht/~sircmpwn/gqlgen/plugin/resolvergen/testdata/singlefile/out")
}
...
func TestLayoutFollowSchema(t *testing.T) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "git.sr.ht/~sircmpwn/gqlgen/plugin/resolvergen/testdata/followschema/out")
